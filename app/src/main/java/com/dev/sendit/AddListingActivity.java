    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!listingDescription.equals("") && !txtLocation.equals("")) {
                    ...
                    Toast.makeText(AddListingActivity.this, "You must specify the description and the location!", Toast.LENGTH_SHORT).show();
                }
