...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.mLocation = view.findViewById(R.id.listLocation);
            holder.mDescription = view.findViewById(R.id.listDescription);
            holder.mIcon = view.findViewById(R.id.listIcon);
